                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="{{ route('ubahtentangkami') }}" method="post" name="chngpwd"
                                            class="form-horizontal" onSubmit="return valid();">
                                            @csrf
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Halaman yang diubah</label>
                                                <div class="col-sm-4">
                                                    <input type='text' class='form-control' value='Tentang Kami'
                                                        readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div>
                                                        <textarea class="form-control" name="tentangkami" id="tentangkami" required>{{ $about }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
